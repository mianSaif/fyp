                               ...
                               <form action="{{ route('create_post') }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                    <div class="col-md-12 col-sm-12 col-xs-12 text-center mb-5">
                                        <img id="blog_image" width="300" class="img-thumbnail text-center" src="{{ asset('admin-assets/img/blog.png') }}" alt="">
                                    </div>  
                                  ...
                                  <div class="col-md-6 col-sm-12 col-xs-12">
                                    ...
                                    <div class="col-md-6 col-sm-12 col-xs-12">
                                        <div class="form-group">
                                            ...
                                            <input accept="image/*" required type="file" onchange="loadFile(event)" name="image" class="form-control" placeholder="Blog Image">
                                        </div>
                                    </div>
