                            ...
                            <table class="table table-striped" id="table-1">
                                ...
                                <tr>
                                    ...
                                    <td>
                                            ...
                                            <a href="{{ URL::route('admin.company_detail', ['company_id' => $company->id]) }}" class="btn btn-info">View</a>
                                      
                                        <form action="{{ route('admin.update_status') }}" method="POST" style="display: contents">
                                            @csrf
