                            ...
                            <div class="col-xl-8">
                                ...
                                <form action="#" class="search-box">
                                    <div class="input-form">
                                        <input type="text" placeholder="Object Tittle or keyword">
                                    </div>
                    ...
                    <div class="col-xl-3 col-lg-3 col-md-4 col-sm-6">
                        <div class="single-services text-center mb-30">
                            ...
                            <div class="services-cap">
                                <h5><a href="job_listing.html">Post Lost Object</a></h5>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-3 col-lg-3 col-md-4 col-sm-6">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="browse-btn2 text-center mt-50">
                            <a href="job_listing.html" class="border-btn2">Register Now To Get Access These Features</a>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row justify-content-center">
                    <div class="col-xl-10">
                        <div class="cv-caption text-center">
                            ...
                            <a href="#" class="border-btn2 border-btn4">Sign Up Now</a>
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <div class="single-job-items mb-30">
                            <div class="job-items">
                                ...
                                <div class="job-tittle">
                                    <a href="job_details.html"><h4>Winston Watch</h4></a>
                                    <ul>
                                        <li>John Smith</li>
                            ...
                            <div class="items-link f-right">
                                <a href="job_details.html">View Detail</a>
                    ...
                    <div class="col-xl-6 col-lg-6">
                        <div class="right-caption">
                            ...
                            <div class="section-tittle section-tittle2">
                                ...
                                <h2>100k people finded their lost object</h2>
                            </div>
                            <div class="support-caption">
                                <p class="pera-top">Mollit anim laborum duis au dolor in voluptate velit ess cillum dolore eu lore dsu quality mollit anim laborumuis au dolor in voluptate velit cillum.</p>
                                <p>Mollit anim laborum.Duis aute irufg dhjkolohr in re voluptate velit esscillumlore eu quife nrulla parihatur. Excghcepteur signjnt occa cupidatat non inulpadeserunt mollit aboru. temnthp incididbnt ut labore mollit anim laborum suis aute.</p>
                                <a href="about.html" class="btn post-btn">Post lost object</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-6 col-lg-6">
